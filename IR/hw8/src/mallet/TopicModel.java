...
public class TopicModel {
    ...
    public static void topicModel(String querry,ArrayList<String> docno) throws Exception {
        ...
        PrintWriter writer = new PrintWriter("C:/Users/Snm/Desktop/HW8/partA/"+querry+"/topics");
        
        for(int i=0;i<docno.size();i++){
        	String tdoc=docno.get(i);
        	Reader fileReader = new InputStreamReader(new FileInputStream(new File("C:/Users/Snm/Desktop/HW8docs/"+tdoc)), "UTF-8");
            instances.addThruPipe(new CsvIterator (fileReader, Pattern.compile("^(\\S*)[\\s,]*(\\S*)[\\s,]*(.*)$"),
                                                   3, 2, 1)); // data, label, name fields
        }
//        Reader fileReader = new InputStreamReader(new FileInputStream(new File("C:/Users/Snm/Desktop/HW8docs/"+docno)), "UTF-8");
//        instances.addThruPipe(new CsvIterator (fileReader, Pattern.compile("^(\\S*)[\\s,]*(\\S*)[\\s,]*(.*)$"),
//                                               3, 2, 1)); // data, label, name fields
...
//            System.out.println(out);
        ...
        PrintWriter writer2 = new PrintWriter("C:/Users/Snm/Desktop/HW8/partA/"+querry+"/probabilities");
        
        InstanceList instances2 = new InstanceList (new SerialPipes(pipeList));
        for(int i=0;i<docno.size();i++){
        	String tdoc=docno.get(i);
        	Reader fileReader = new InputStreamReader(new FileInputStream(new File("C:/Users/Snm/Desktop/HW8docs/"+tdoc)), "UTF-8");
            instances2.addThruPipe(new CsvIterator (fileReader, Pattern.compile("^(\\S*)[\\s,]*(\\S*)[\\s,]*(.*)$"),
                                                   3, 2, 1)); // data, label, name fields
        
        
        // Create a new instance named "test instance" with empty target and source fields.
        InstanceList testing = new InstanceList(instances2.getPipe());
